...
- The team verifies that previously generated gentx are valid with the new base Genesis v2
- The team proceeds directly with the launch phase
- A new preparation document specific to the launch event is published
...
Once the team received and processed all individual Genesis files:

1. **The team extracted** all accounts and balances from all received Genesis files
2. **The team created** the new base Genesis v2 that includes all accounts from the start
3. **The team verified** that the gentx previously generated by participants are valid with the new base Genesis v2
